...
// mysql 客户端标示参数client_flags 
// 在mysql_connect 时作为参数使用
// 参考资料 https://dev.mysql.com/doc/internals/en/binlog-event-flag.html
...
// binlog 解析事件类型，共有36种事件
type EventType byte

const (
	UNKNOWN_EVENT EventType = iota  //0
	START_EVENT_V3  				//1
	QUERY_EVENT  					//2	变更表/结构
	STOP_EVENT  					//3
	ROTATE_EVENT  					//4	切换binlog文件
	INTVAR_EVENT 					//5
	LOAD_EVENT  					//6
	SLAVE_EVENT 					//7
	CREATE_FILE_EVENT 				//8
